...
import * as Style from "./Drawing.styles";
...
const Drawing = () => {
  ...
  return (
    <Style.Container>
      <Style.Title>
        <h1>Escolha um dos formatos abaixo:</h1>
      </Style.Title>
      <Style.Content>
        <Style.Column>
          <Style.Subtitle>
            <Style.FormatButton onClick={() => navigate("/sorteio/americano")}>
              Americano
            </Style.FormatButton>
          </Style.Subtitle>
          <Style.Text>
        ...
        <Style.Column>
          <Style.Subtitle>
            <Style.FormatButton onClick={() => navigate("/sorteio/duplas")}>
              Duplas
            </Style.FormatButton>
          </Style.Subtitle>
          <Style.Text>
